...
class ModeloUsuarios{
    ...
    static public function mdlListarUsuarios($item, $valor){
        ...
        if($item == null){
            ...
            $stmt = Conexion::conectar()->prepare("SELECT U.*, 
                                                          R.NOMBRE_ROL
                                                    FROM usuario U
                                                    INNER JOIN rol_usuario R ON R.ID_ROL = U.ROL_USUARIO
    ...
    static public function mdlListarRolesUsuario($item, $valor){
        ...
        if($item == null){
            ...
            $stmt = Conexion::conectar()->prepare("SELECT * FROM rol_usuario WHERE ESTADO_REGISTRO = 1");
            ...
            $stmt = Conexion::conectar()->prepare("SELECT * FROM rol_usuario WHERE $item = :$item");
    ...
    static public function mdlRegistrarUsuario($datos){
        ...
        $stmt = Conexion::conectar()->prepare("INSERT INTO usuario (USUARIO,
                                                             ...
                                                             VALUES(UPPER(:USUARIO),
                                                                    :CLAVE,
                                                                    INITCAP(:NOMBRE_USUARIO),
                                                                    INITCAP(:APELLIDO_USUARIO),
                                                                    :ROL_USUARIO)");
    ...
    static public function mdlEditarUsuario($datos){
        ...
        $stmt = Conexion::conectar()->prepare("UPDATE usuario SET NOMBRE_USUARIO = INITCAP(:NOMBRE_USUARIO),
                                                                  APELLIDO_USUARIO = INITCAP(:APELLIDO_USUARIO),
                                                                  CLAVE = :CLAVE,
