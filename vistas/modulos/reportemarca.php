  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Reporte por marca y modelo</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="card-header">
          <form rol="form" method="POST">
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-12 col-sm-2 mb-1">
                <div class="input-group align-items-center">
                  Marca: <select name="idMarcaVehiculo" id="idMarcaVehiculo" class="form-control" required>
              ...
              <div class="col-xs-12 col-sm-2 mb-1">
                <div class="input-group align-items-center">
                  Modelo: <select name="idModeloVehiculo" id="idModeloVehiculo" class="form-control">
        ...
        <div class="card-body">
          <table class="table table-bordered table-striped table-hover" id="example1">
            ...
            <?php
              ...
              $reporteGeneral = ControladorServicio::ctrReporteMarcaModelo();
